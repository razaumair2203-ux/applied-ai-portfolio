...
![Telemetry formatter-parser replay](../visuals/mbse/telemetry_replay.svg)
...
The public machine-readable record is in [`evidence/mbse/telemetry_replay_cases.json`](../evidence/mbse/telemetry_replay_cases.json).
...
That assurance discipline is carried into the public [Clear Run mission-verification matrix](../evidence/clear-run/mission_verification_matrix.json).
...
[Back to portfolio](../README.md) · [Clear Run / TIR-FOD case study](tir-fod-clear-run.md) · [Technical evidence](../evidence/README.md)
